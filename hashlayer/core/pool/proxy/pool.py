...
from hashlayer.core.pool.pool import PoolBase, PoolIndex
...
class ProxyPool(PoolBase):
    """
    HashLayer Proxy pool implementation.

    This pool implementation connects to a HashLayer proxy instance to retrieve
