...
class BaseStorage(ABC):
    ...
    def get_config(self):
        """Returns the config object for
        specific storage based on class implementation."""
        parser = ArgumentParser()
        self.add_args(parser)
        return Config(parser)

    @staticmethod
    def generate_user_id(config: "Config") -> str:
        """
        ...
        Returns:
            str: A unique prefix string for this neuron based on netuid,
